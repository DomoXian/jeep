...
public class MyBatisGenConst {
     ...
     * 项目名称
     */
    private static final String PROJECT_NAME = "jeep";
     ...
     * 数据库名
     */
    private static final String DB_NAME = "jeep";
    ...
    // mapper
    public static final String MAPPER_PACKAGE = MAIN_PACKAGE + ".mapper." + DB_NAME;
    public static final String MAPPER_EXT_PACKAGE = MAPPER_PACKAGE + ".ext";


    // manager
    public static final String MANAGER_PACKAGE = MAIN_PACKAGE + ".manager";
    ...
    // mapper xml 输出目录
    public static final String MAPPER_XML_DIR = MODULE_DIR + "src/main/resources/mapper/" + DB_NAME + File.separator;
    // mapper-ext xml 输出目录
    ...
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = MODULE_CODE_DIR + "dal/mapper" + File.separator + DB_NAME;
    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = MAPPER_JAVA_DIR + "/ext";

    public static final String MANAGER_JAVA_DIR = MODULE_CODE_DIR + "dal/manager";
